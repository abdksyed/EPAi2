...
@timed(1)
def nt_approach(n: int) -> namedtuple:
    '''
...
def stock(count: int) -> tuple:
    ...
    for i in range(count):
        ...
        variations = []
        for i in range(100):  # 100 Times during a Day
...
@timed(1)
@simulate_stock(10)
def tsai_index(num_comp: int) -> namedtuple:
    """
